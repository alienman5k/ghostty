    ...
    profiles.user.databases = [
      {
        settings = with lib.gvariant; {
          "org/gnome/desktop/background" = {
            picture-uri = "file://${pkgs.ghostty}/share/icons/hicolor/512x512/apps/com.ghostty.terminal.png";
            picture-uri-dark = "file://${pkgs.ghostty}/share/icons/hicolor/512x512/apps/com.ghostty.terminal.png";
  ...
  system.activationScripts = {
    face = {
      text = ''
        ...
        cp ${pkgs.ghostty}/share/icons/hicolor/1024x1024/apps/com.ghostty.terminal.png /var/lib/AccountsService/icons/ghostty
